...
export default function ReportingSubMenu() {
  return (
    <nav className="sticky top-[65px] z-40 flex items-end justify-center gap-0 px-8 pt-1 pb-[4px] border-b border-gray-300" style={{ backgroundColor: 'rgb(235, 234, 230)' }}>
