...
const NonInvoicedOrders = () => {
    ...
    return (
        <div className="flex h-full flex-col pt-3 pb-4 ps-10 pe-0">
            {/* <div className="mt-2 text-sm text-gray-500">Ej fullt fakturerade order</div> */}
                        ...
                        <tr>
                            {columns.map((col) => (
                                <th
                                    ...
                                    className={`overflow-hidden text-ellipsis whitespace-nowrap px-2 py-1.5 text-tiny font-medium text-gray-500 cursor-pointer select-none hover:text-gray-700 ${col.align === 'right' ? 'text-right' : col.align === 'center' ? 'text-center' : 'text-left'}`}
                                >
                        ...
                        {showSkeleton ? (
                            ...
                            rows.map((row) => (
                                <tr
                                    ...
                                    className={`cursor-pointer ${row.id === selectedRowId ? 'bg-lime-100' : 'hover:bg-lime-50'}`}
                                >
