                            ...
                            filteredItems.map((item) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full text-left text-xs px-2 py-0.5 rounded-sm grid grid-cols-[1fr_50px] gap-2 ${isSelected ? 'bg-yellow-300 text-black' : 'hover:bg-gray-100 text-gray-900'}`}
                                    >
