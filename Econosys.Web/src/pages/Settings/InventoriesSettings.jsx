                            ...
                            filteredItems.map((item) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full h-6 items-center text-left text-xs px-2 py-0.5 rounded-sm grid grid-cols-[1fr_80px] gap-2 ${isSelected ? 'bg-purple-200/50 text-black' : 'hover:bg-gray-100 text-gray-900'}`}
                                    >
